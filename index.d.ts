 ...
 * @param options.foreignKeySuffix Set foreign key suffix (default: `'Id'`)
 * @param options.postRoutes Array of routes to add after the default routes
 */
export function router<T extends object>(
  source: LowdbSync<T> | T | string,
  options?: {
    foreignKeySuffix?: string
    postRoutes?: ApplicationRequestHandler[]
  }
): JsonServerRouter<T>
